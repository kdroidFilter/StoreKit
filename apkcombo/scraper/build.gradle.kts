...
group = "io.github.kdroidfilter.storekit.apkcombo.scraper"
...
android {
    namespace = "io.github.kdroidfilter.storekit.apkcombo.scraper"
    compileSdk = 35
...
mavenPublishing {
    coordinates(
        ...
        artifactId = "storekit-apkcombo-scraper",
        version = version.toString()
    )

    pom {
        name.set("APKCombo Scraper Library")
        description.set("APKCombo Scraper Library is a Kotlin library for extracting app data from the APKCombo website.")
